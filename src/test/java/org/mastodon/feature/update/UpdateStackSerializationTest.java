...
public class UpdateStackSerializationTest
{
	...
	public static class FT4serializer implements FeatureSerializer< Spot, FT4 >
	{
		...
		@Override
		public FT4 deserialize( final FileIdToObjectMap< Spot > idmap, final RefCollection< Spot > pool, final String spaceUnits, final String timeUnits, final ObjectInputStream ois ) throws IOException, ClassNotFoundException
		{
