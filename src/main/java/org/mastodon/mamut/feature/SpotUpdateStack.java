...
public class SpotUpdateStack extends UpdateStack< Spot >
{
	 ...
	 */
	SpotUpdateStack( final RefCollection< Spot > pool, final SizedDeque< UpdateState< Spot > > stateStack, final Update< Spot > currentUpdate )
	{
		super( pool, stateStack, currentUpdate );
	}
