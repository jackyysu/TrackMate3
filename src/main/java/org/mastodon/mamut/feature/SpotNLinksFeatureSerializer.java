...
public class SpotNLinksFeatureSerializer implements FeatureSerializer< Spot, SpotNLinksFeature >
{

	@Override
	public String getFeatureKey()
	{
		return SpotNLinksFeature.KEY;
	}
	...
	@Override
	public SpotNLinksFeature deserialize( final FileIdToObjectMap< Spot > idmap, final RefCollection< Spot > pool, final String spaceUnits, final String timeUnits, final ObjectInputStream ois ) throws IOException, ClassNotFoundException
	{
