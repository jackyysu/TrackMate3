...
public class SpotGaussFilteredIntensityFeatureSerializer implements FeatureSerializer< Spot, SpotGaussFilteredIntensityFeature >
{

	@Override
	public String getFeatureKey()
	{
		return SpotGaussFilteredIntensityFeature.KEY;
	}
	...
	@Override
	public SpotGaussFilteredIntensityFeature deserialize( final FileIdToObjectMap< Spot > idmap, final RefCollection< Spot > pool, final String spaceUnits, final String timeUnits, final ObjectInputStream ois ) throws IOException, ClassNotFoundException
	{
